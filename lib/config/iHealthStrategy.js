...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  params.sv = "0b79266124744421aef845320f815e77";
  params.sc = "f3e8cdb147c84f8d930a3b1ab7960508";
  var url = 'https://api.ihealthlabs.com:8443/openapiv2/user/'+this.userId+'.json/?'+querystring.stringify( params );
  console.log(url);
...
Strategy.prototype.getBPDatas = function(id, accessToken, callback) {
    var params = {};
    params.access_token = accessToken;
    params.sv = config.iHealth.OpenApiBP.sv;
    params.sc = config.iHealth.OpenApiBP.sc;
    var url = 'https://api.ihealthlabs.com:8443/openapiv2/user/'+id+'/bp.json/?'+querystring.stringify( params );
    console.log(url);
    this._oauth2.get(url, accessToken, function (err, body, res) {
        if (err) { return done(new InternalOAuthError('failed to fetch user profile', err)); }
