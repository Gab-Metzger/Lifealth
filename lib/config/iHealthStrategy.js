...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://sandbox.ihealthlabs.com:8443/OpenApiV2/OAuthv2/userauthorization/';
  options.tokenURL = options.tokenURL || 'https://sandbox.ihealthlabs.com:8443/OpenApiV2/OAuthv2/userauthorization/';
