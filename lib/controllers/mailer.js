...
exports.sendMail = function(patient, doctor, notes) {
  var drMsg = (notes && notes.length > 0)?'<br><br>Message du Dr '+doctor.firstName+' '+doctor.lastName+':<br> '+notes.replace("\n","<br>"):'';
  var mailOptions = {
