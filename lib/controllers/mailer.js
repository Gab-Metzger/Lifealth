...
exports.sendMail = function(email) {
  var mailOptions = {
    ...
    text: 'Avec Lifealth partagez vos donées avec votre médecin et gérer votre parcours de soins.\n\nInscrivez-vous en suivant ce lien http://'+config.ip+'/subscribe?email='+email+'\n\nService Relation Client\nLifealth',
    html: 'Avec Lifealth partagez vos donées avec votre médecin et gérer votre parcours de soins.<br><br><a href="http://'+config.ip+':'+config.port+'/subscribe?email='+email+'">Inscrivez-vous</a><br><br>Service Relation Client<br>Lifealth'
  };
