...
var mail = require('nodemailer').createTransport("SMTP", {
  ...
  debug: true,
  auth: {
    user: 'hello@itaware.eu',
    pass: 'ta45dr39'
  }
});

exports.sendMail = function(patient, doctor) {
  var mailOptions = {
    ...
    html: 'Bonjour '+patient.firstName+' '+patient.lastName+',<br><br>Pour partager vos données avec votre médecin :<br><br><a href="http://'+config.domain+'/subscribe?email='+email+'">Inscrivez-vous</a><br><br>En cas de besoin veuillez consulter : <ul><li><a href="https://docs.google.com/document/d/1pKJvOGKm1WKryeDiMXvJL2z6fhf1a8OX-gDjmgrAELM/edit?usp=sharing">Protocole BP5 tension artérielle</a><li><a href="https://docs.google.com/document/d/1ZESp_kJ_5erU-0vPArtXTU8gFCb4OK1dmHBCRWb3wuo/edit">Protocole BG5 glycémie</a></li></li></ul><br><br>Service Relation Client<br>Lifealth'
  };
